...
//  'sourceLanguage'=>'en',
  ...
  'defaultController'=>'do',
    ...
    'application.components.core.ajax.*',
	),
    ...
    'conf'=>array(
      ...
      'showScriptName'=>false,
			'rules'=>array(
				'/'=>'do/index',
				'logout'=>'do/logout',
        ADMIN_MODULE=>ADMIN_MODULE.'/main/index',
        '<controller:\w+>'=>'<controller>/index',
        '<module:\w+>/<controller:\w+>'=>'<module>/<controller>/index',
        '<module:\w+>/core/<controller:\w+>'=>'<module>/core/<controller>/index',
        '<module:\w+>/core/<controller:\w+>/<action:\w+>'=>'<module>/core/<controller>/<action>',
